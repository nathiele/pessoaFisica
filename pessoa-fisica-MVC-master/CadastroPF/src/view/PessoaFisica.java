...
import controller.conexaoPessoas;
	...
	public PessoaFisica(){
		...
		btnSalvar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				PessoaFisicaA pf = new PessoaFisicaA();
				pf.setNome(txtNome.getText().toString());
				...
				pf.setCelular(txtCel.getText());
				pf.setCpf(txtCpf.getText().toString());
				...
				try {
					...
					conexaoPessoas con = new conexaoPessoas(connection);
					con.salvar(pf);
		...
		btnImprimir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Nome: "+pfa.getNome()+
						"Endereco: "+pfa.getEndereco()+
						"Bairro: "+pfa.getBairro()+
						"Cep: "+pfa.getCep()+
						"Cidade: "+pfa.getCidade()+
						"Estado: "+pfa.getEstado()+
						"Telefone: "+pfa.getTelefone()+
						"Celular: "+pfa.getCelular()+
						"Rg: "+pfa.getRg()+
						"Cpf: "+pfa.getCpf()+
						"Sexo: "+pfa.getSexo()
						);
